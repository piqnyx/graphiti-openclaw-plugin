...
test("status reports the communities and how stale they are", async (t) => {
  installFetch(t, {
    get_queue_status: () => ({ group_id: "main", blocked: false, attempts: 0, pending: 0 }),
    get_episodes: () => ({ episodes: [] }),
    get_graph_stats: () => ({
      size: { entities: 10, episodes: 4, sagas: 1, facts: 9, mentions: 12 },
      top_entities: [],
      communities: {
        count: 2,
        built_at: "2026-08-17T04:00:00+00:00",
        episodes_since_build: 7,
        largest: [
          { name: "Дом и переезды", members: 14, summary: "Вит живёт в Григолети." },
          { name: "Работа", members: 6, summary: "" },
        ],
      },
      integrity: {
        duplicate_episode_names: [], episodes_without_saga: 0, episodes_without_entities: 0,
...
test("status says communities were never built rather than staying silent", async (t) => {
  installFetch(t, {
    get_queue_status: () => ({ group_id: "main", blocked: false, attempts: 0, pending: 0 }),
    get_episodes: () => ({ episodes: [] }),
    get_graph_stats: () => ({
      ...
      top_entities: [],
      communities: { count: 0, built_at: null, episodes_since_build: 0, largest: [] },
      integrity: {
        duplicate_episode_names: [], episodes_without_saga: 0, episodes_without_entities: 0,
        sagas_with_broken_chain: [], facts_without_provenance: 0, isolated_entities: 0,
      },
  ...
  const result = await call(tools, "graphiti_status", {}, { agentId: "main", sessionKey: "agent:main:web:1" });
  assert.match(result.content[0].text, /Communities: none built yet/);
});
